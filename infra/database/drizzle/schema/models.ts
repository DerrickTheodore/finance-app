...
export type User = typeof users.$inferSelect; // For selecting users
...
export type PlaidItemModel = typeof plaidItems.$inferSelect; // Renamed from PlaidItem
export type NewPlaidItemModel = typeof plaidItems.$inferInsert; // Renamed from NewPlaidItem
...
export const categories = pgTable(
  ...
  (table) => {
    return {
      userIdNameUnq: uniqueIndex("category_user_id_name_unq").on(
        table.userId,
        table.name
      ),
    };
...
export const transactionsCategories = pgTable(
...
// Infer select and insert types for new tables
